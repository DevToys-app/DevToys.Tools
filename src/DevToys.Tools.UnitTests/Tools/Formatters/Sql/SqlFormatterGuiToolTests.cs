...
namespace DevToys.Tools.UnitTests.Tools.Formatters.Sql;

public class SqlFormatterGuiToolTests : TestBase
{
    ...
    {
        _tool = new SqlFormatterGuiTool(new MockISettingsProvider());
