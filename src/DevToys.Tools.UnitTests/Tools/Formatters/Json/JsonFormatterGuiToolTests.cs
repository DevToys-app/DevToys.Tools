...
namespace DevToys.Tools.UnitTests.Tools.Formatters.Json;

public class JsonFormatterGuiToolTests : TestBase
{
    ...
    {
        _tool = new JsonFormatterGuiTool(new MockISettingsProvider());
