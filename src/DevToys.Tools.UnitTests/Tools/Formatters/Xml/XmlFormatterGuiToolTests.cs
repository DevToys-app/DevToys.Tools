...
namespace DevToys.Tools.UnitTests.Tools.Formatters.Xml;

public class XmlFormatterGuiToolTests : TestBase
{
    ...
    {
        _tool = new XmlFormatterGuiTool(new MockISettingsProvider());
