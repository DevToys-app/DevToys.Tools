...
namespace DevToys.Tools.UnitTests.Tools.Generators;

[Collection(nameof(TestParallelizationDisabled))]
public sealed class HashAndChecksumGeneratorCommandLineToolTests : TestBase
{
    ...
    {
        _tool = new HashAndChecksumGeneratorCommandLineTool();
        _tool.Silent = true;
